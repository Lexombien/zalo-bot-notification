<?php
/**
 * Plugin Name: WooCommerce Zalo Bot Notification
 * Plugin URI: https://github.com/lexombien/woo-zalo-bot-notification
 * Description: Gửi thông báo đơn hàng WooCommerce về Zalo Bot khi trạng thái đơn hàng thay đổi
 * Version: 2.25.0
 * Author: Lexombien
 * Author URI: https://lexombien.com
 * License: GPL v2 or later
 * License URI: https://www.gnu.org/licenses/gpl-2.0.html
 * Text Domain: woo-zalo-bot
...
function wzb_woocommerce_missing_notice() {
    ?>
    <div class="error">
        <p><?php _e('WooCommerce Zalo Bot Notification yêu cầu WooCommerce phải được cài đặt và kích hoạt.', 'woo-zalo-bot'); ?></p>
    </div>
    <?php
}
...
function wzb_add_row_meta_links($links, $file) {
    if ($file === WZB_PLUGIN_BASENAME) {
        $links[] = '<a href="https://github.com/lexombien/woo-zalo-bot-notification/releases" target="_blank">📜 Lịch sử phiên bản</a>';
    }
    return $links;
}
