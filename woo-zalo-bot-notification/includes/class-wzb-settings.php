...
class WZB_Settings {
    ...
    public static function add_menu_page() {
        add_menu_page(
            __('Zalo Bot Notification', 'woo-zalo-bot'),
            __('Zalo Bot', 'woo-zalo-bot'),
            'manage_options',
            'woo-zalo-bot',
    ...
    public static function load_admin_assets($hook) {
        ...
        if (strpos($hook, 'woo-zalo-bot') === false) {
            return;
        }
    ...
    public static function render_settings_page() {
        ...
        if (isset($_POST['wzb_save_settings']) && $_POST['wzb_save_settings'] == '1') {
            ...
            $log_content = "=== SAVE ATTEMPT (JSON STRING): " . date('Y-m-d H:i:s') . " ===\n";
            
            if (check_admin_referer('wzb_save_settings_action', 'wzb_save_nonce')) {
                $input = $_POST['wzb_settings'] ?? array();
            ...
            <div class="wzb-container">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" 
                                               ...
                                               required>
                                        <p class="description">
                                            Token được cung cấp sau khi tạo bot. Xem <a href="admin.php?page=woo-zalo-bot-guide" target="_blank">hướng dẫn</a> để biết cách lấy token.
                                        </p>
                                    </td>
                                </tr>
                ...
                <div class="wzb-sidebar">
                    <div class="wzb-card wzb-info-box">
                        <h3>ℹ️ Thông tin</h3>
                        <p><strong>Version:</strong> <?php echo WZB_VERSION; ?></p>
    ...
    public static function ajax_test_connection() {
        ...
        $chat_ids_str = sanitize_text_field($_POST['chat_id'] ?? '');
    ...
    public static function ajax_setup_webhook() {
        ...
        $bot_token = sanitize_text_field($_POST['bot_token'] ?? $settings['bot_token'] ?? '');
        $webhook_url = sanitize_text_field($_POST['webhook_url'] ?? $settings['webhook_url'] ?? '');
    ...
    public static function ajax_get_sample_order_meta() {
        ...
        $formatted_meta[] = array('key' => 'formatted_order_total', 'value' => strip_tags($order->get_formatted_order_total()));
